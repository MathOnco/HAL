...
class ExampleCell extends AgentPT2D<BirthDeathOffLattice> {
    int color;
...
public class BirthDeathOffLattice extends AgentGrid2D<ExampleCell> {
    Rand rng = new Rand();
    int[] divHood = Util.VonNeumannHood(false);
    double[] moveCoords = new double[2];

    public BirthDeathOffLattice(int x, int y) {
    ...
    public static void main(String[] args) {
        ...
        BirthDeathOffLattice model = new BirthDeathOffLattice(x, y);
