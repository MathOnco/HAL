package Examples._O3BirthDeathMutation;
...
class CellEx extends AgentSQ2Dunstackable<BirthDeadthMutation>{
    int nMutations;
...
public class BirthDeadthMutation extends AgentGrid2D<CellEx> {
    ...
    GuiGridVis vis;
    public BirthDeadthMutation(int x, int y, GuiGridVis vis) {
    ...
    public static void main(String[]args){
        ...
        BirthDeadthMutation grid=new BirthDeadthMutation(x,y,vis);
        grid.InitTumor(5);
