...
public class FFTbase {
    ...
    public static double[] fft(double[] real_imag_array, boolean DIRECT) {
        // - n is the dimension of the problem
        // - nu is its logarithm in base e
        int n = real_imag_array.length/2; // (Re,IM) pairs
...
//        }
        ...
        for (int i = 0; i < n*2; i += 2) {
            ...
            xReal[i2]=real_imag_array[i];
            xImag[i2]=real_imag_array[i+1];
        }
