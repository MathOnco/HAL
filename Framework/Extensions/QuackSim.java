...
class TreatmentBar {
    ...
    TreatmentBar(QuackSim myLab, int index, int timescaleX, int timescaleY, int intensityScaleX) {
        this.index = index;
        this.myLab = myLab;
...
public class QuackSim extends GuiWindow{
    //GUI CONSTANTS
    ...
    public QuackSim(TreatableTumor myModel, int nSteps, int stateSaveFreq, int visScale, int timeScaleX, int barScaleY, int intensityScaleX, int stepMSmin, int stepMSmax) {
