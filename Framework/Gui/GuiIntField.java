 ...
 */
public class GuiIntField extends JFormattedTextField implements Framework.Interfaces.MenuItem,GuiComp {
     ...
     */
    public GuiIntField(String label, int initVal, int min, int max, int nCols, int compX, int compY){
        super(intFormat);
        this.initVal=Integer.toString(initVal);
        this.compX=compX;
        this.compY=compY;
    ...
    /**
     * sets the foreground and background of the GuiIntField
     ...
     */
    public GuiIntField SetColor(Color foregroundColor, Color backgroundColor){
    ...
    public GuiIntField SetColor(int foregroundColor, int backgroundColor){
