 ...
 */
public class GuiComboBoxField extends JComboBox implements Framework.Interfaces.MenuItem,GuiComp {
    String labelText;
    JLabel label;
    int compX;
    int compY;
     ...
     */
    public GuiComboBoxField(String label, int initVal, String[] options, int compX, int compY){
        super(options);
        this.initVal=Integer.toString(initVal);
        this.labelText=label;
        this.label=new JLabel(labelText);
    ...
    /**
     * sets the foreground and background of the GuiComboBoxField
     ...
     */
    public GuiComboBoxField SetColor(Color foregroundColor, Color backgroundColor){
    ...
    public GuiComboBoxField SetColor(int foregroundColor, int backgroundColor){
