 ...
 */
public class GuiDoubleField extends JFormattedTextField implements Framework.Interfaces.MenuItem,GuiComp {
     ...
     */
    public GuiDoubleField(String label, double initVal, double min, double max, int nCols, int compX, int compY){
        super(doubleFormat);
        this.initValue=Double.toString(initVal);
    ...
    /**
     * sets the foreground and background of the GuiDoubleField
     ...
     */
    public GuiDoubleField SetColor(Color foregroundColor, Color backgroundColor){
    ...
    public GuiDoubleField SetColor(int foregroundColor, int backgroundColor){
