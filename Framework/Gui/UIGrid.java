...
//     * @param active
//     */
//    public UIGrid(int gridW, int gridH, int scaleX,int scaleY, int compX, int compY, boolean active){
//        this.active= active;
//        xDim=gridW;
//        yDim=gridH;
//        length=gridH*gridW;
...
//        }
//    }
//    public UIGrid(int gridW, int gridH, int scaleX,int scaleY, int compX, int compY){
//        this.active= true;
//        xDim=gridW;
//        yDim=gridH;
//        length=gridH*gridW;
...
//     * @param gridH height of the UIGrid in pixels
//     */
//    public UIGrid(int gridW, int gridH, int scaleX,int scaleY,boolean active){
//        this.active=active;
//        xDim=gridW;
//        yDim=gridH;
//        length=gridH*gridW;
...
//        }
//    }
//    public UIGrid(int gridW, int gridH, int scaleX,int scaleY){
//        this.active=true;
//        xDim=gridW;
//        yDim=gridH;
//        length=gridH*gridW;
...
//    }
    ...
    public void DrawShapeHood(int i, int[]Shapehood, int[]ColorInts){
            ...
            for(int k=0;k<Shapehood.length/2;k++) {
                ...
                if (!Util.InDim(x, xDim)||!Util.InDim(y, yDim)) {
                        continue;
                }
