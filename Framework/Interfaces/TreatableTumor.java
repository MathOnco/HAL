...
public interface TreatableTumor extends SerializableModel {
    void Draw(UIGrid vis, UIGrid alphaVis, int iLastSelected, UILabel drawLabel, double[]treatmentVals);//alphaVis draws over vis if alpha values are set to nonzero
