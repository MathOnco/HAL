 ...
 * generate subtasks. Class {@code SplittableRN} supports methods for
 ...
 * SplittableRN instance that shares no mutable state with the
 * current instance. However, with very high probability, the
 * values collectively generated by the two objects have the same
 * statistical properties as if the same quantity of values were
 * generated by a single thread using a single {@code
 * SplittableRN} object.  </li>
 *
 * <li>Instances of SplittableRN are <em>not</em> thread-safe.
 ...
 * </ul>
 *
 * <p>Instances of {@code SplittableRN} are not cryptographically
...
public final class SplittableRN implements Serializable,RNG {
     ...
     * SplittableRN instances are highly likely to be different.
     *
     ...
     * and gamma for another SplittableRN.  To conservatively
     ...
     * split() for a common "defaultGen" SplittableRN.  Unlike
     * other cases, this split must be performed in a thread-safe
     * manner, so we use an AtomicLong to represent the seed rather
     * than use an explicit SplittableRN. To bootstrap the
     ...
     */
    private SplittableRN(long seed, long gamma) {
        this.seed = seed;
        this.gamma = gamma;
    }
    ...
    /**
     * Creates a new SplittableRN instance using the specified
     * initial seed. SplittableRN instances created with the same
    ...
    /**
     * Creates a new SplittableRN instance that is likely to
     * generate sequences of values that are statistically independent
     * of those of any other instances in the current program; and
     * may, and typically does, vary across program invocations.
     */
    public SplittableRN() { // emulate defaultGen.split()
    ...
    /**
     * Constructs and returns a new SplittableRN instance that
     * shares no mutable state with this instance. However, with very
     * high probability, the set of values collectively generated by
     * the two objects has the same statistical properties as if the
     * same quantity of values were generated by a single thread using
     * a single SplittableRN object.  Either or both of the two
     * objects may be further split using the {@code split()} method,
     * and the same expected statistical properties apply to the
     * entire set of generators constructed by such recursive
     * splitting.
     *
     * @return the new SplittableRN instance
     */
    public SplittableRN split() {
        return new SplittableRN(nextLong(), mixGamma(nextSeed()));
    }
    ...
    static final class RandomIntsSpliterator implements Spliterator.OfInt {
        final SplittableRN rng;
        long index;
        final long fence;
        final int origin;
        final int bound;
        RandomIntsSpliterator(SplittableRN rng, long index, long fence,
    ...
    static final class RandomLongsSpliterator implements Spliterator.OfLong {
        ...
        final long origin;
        final long bound;
        RandomLongsSpliterator(SplittableRN rng, long index, long fence,
    ...
    static final class RandomDoublesSpliterator implements Spliterator.OfDouble {
        ...
        final double origin;
        final double bound;
        RandomDoublesSpliterator(SplittableRN rng, long index, long fence,
