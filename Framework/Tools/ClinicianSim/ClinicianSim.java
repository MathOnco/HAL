package Framework.Tools.ClinicianSim;
...
//    final UIButton setAllBtn;
    ...
    TreatmentBar(ClinicianSim myLab, int index, int timescaleX, int timescaleY, int intensityScaleX, int maxIntensity) {
        this.index = index;
        this.myLab = myLab;
...
public class ClinicianSim extends UIWindow {
    ...
    public ClinicianSim(TreatableTumor myModel, int nSteps, int stateSaveFreq, int visX, int visY, int visScale, int timeScaleY, int intensityScaleX, int stepMSmax,boolean redrawOnTreatmentSwitch,boolean quickStart) {
