...
public interface SerializableModel extends Serializable{
    ...
    public void SetupConstructors();//sets up the constructors for all Grid2Ds/Grid3Ds, use the _SetupAgentListConstructor() function to do this, if no Grid2Ds or Grid3Ds are being used, this function can be left empty
